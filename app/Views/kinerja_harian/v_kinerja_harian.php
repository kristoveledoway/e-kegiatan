        ...
        <div id="main">
            ...
            <div class="page-heading">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Data Kinerja Harian</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <a href="kinerja_harian/tambah_data" class="btn btn-success">Tambah Data</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    <?php $no = 1; ?>
                                    <?php foreach ($kinerja_harians as $kj) : ?>
                                    <tr>
                                        <td><?= $no++; ?>.</td>
                                        <td><?= $kj->nama_pegawai ?></td>
                                        <td><?= $kj->tgl ?></td>
                                        <td><?= $kj->posisi_pegawai ?></td>
                                        <td><?= $kj->kegiatan ?></td>
                                        <td><?= $kj->quantity ?></td>
                                        <td><?= $kj->output_pekerjaan ?></td>
                                        <td><?= $kj->keterangan ?></td>
                                        <td>
                                            <a class="btn btn-sm btn-success" href="<?= base_url('kinerja_harian/edit/'.$kj->id_kinerja_harian) ?>">Edit</a>
                                            <a class="btn btn-sm btn-danger" href="<?= base_url('kinerja_harian/hapus/'.$kj->id_kinerja_harian) ?>">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
