        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <a href="/pegawai/tambah_data" class="btn btn-success">Tambah Data</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success" href="<?= base_url('pegawai/edit/'.$pegawai['id_pegawai']) ?>">Edit</a>
                                            <a class="btn btn-sm btn-danger" href="<?= base_url('pegawai/hapus/'.$pegawai['id_pegawai']) ?>">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
