                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form" action="<?= base_url('master_pegawai/tambah_data') ?>" method="post">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="first-name-column">Nama Pegawai</label>
                                                    <input type="hidden" name="id_master_pegawai">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group">
                                                        <select name="id_sub_bagian" class="choices form-select">
                                                            ...
                                                            <option value="<?= $sub_bagian['id_sub_bagian'] ?>"><?= $sub_bagian['nama_sub_bagian'] ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
